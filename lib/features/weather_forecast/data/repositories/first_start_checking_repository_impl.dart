...
import 'package:task_ms/features/weather_forecast/domain/repositories/first_start_checking_repository.dart';

// @Injectable(as: WeatherForecastRepository)
class FirstStartCheckingRepositoryImpl implements FirstStartCheckingRepository {
  FirstStartCheckingRepositoryImpl({
  ...
  @override
  Future<Either<Failure, CityNameListModel?>> getCityName(
